...
def fieldDetection(image_color, x_old, y_old, field_found, video_height, video_width, threshold):
    """
    ...
    _, image = cv.threshold(gray, threshold, 255, cv.THRESH_BINARY)
    field_moved = False
    ...
    field_image = image_color[y_upper:y_lower, x_left:x_right]
